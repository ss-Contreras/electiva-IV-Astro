...
const PacienteComponent: React.FC = () => {
  ...
  const fetchPacientes = async () => {
    try {
      const response = await axios.get<Paciente[]>('http://sonrisasbackendelectivaiv.somee.com/api/paciente');
  ...
  const fetchOdontologos = async () => {
    try {
      const response = await axios.get<Odontologo[]>('http://sonrisasbackendelectivaiv.somee.com/api/odontologo');
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post('http://sonrisasbackendelectivaiv.somee.com/api/paciente', payload);
  ...
  const handleEditSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.put(`http://sonrisasbackendelectivaiv.somee.com/api/paciente/${pacienteToEdit.id}`, payload);
  ...
  const handleDelete = async (id: number) => {
    ...
    setActionLoading(true);
    try {
      const response = await axios.delete(`http://sonrisasbackendelectivaiv.somee.com/api/paciente/${id}`);
      if (response.status === 200) {
        await fetchPacientes();
